...
"color: rgb(255, 255, 255);"));
        ...
        font.setBold(true);
        font.setItalic(true);
        next_pushButton->setFont(font);
        next_pushButton->setCursor(QCursor(Qt::OpenHandCursor));
...
"color: rgb(255, 255, 255);"));
        ...
        back_pushButton->setCursor(QCursor(Qt::OpenHandCursor));
...
"color: rgb(255, 255, 255);"));
        ...
        label_inp_name->setGeometry(QRect(120, 60, 311, 21));
        QFont font1;
        font1.setFamilies({QString::fromUtf8("Cambria")});
        font1.setPointSize(14);
        font1.setBold(true);
        font1.setItalic(true);
        label_inp_name->setFont(font1);
        ...
        student_fullname->setFont(font3);
...
"alternate-background-color: rgb(90, 184, 255);"));
    ...
    {
        add_mark->setWindowTitle(QCoreApplication::translate("add_mark", "Choose student", nullptr));
