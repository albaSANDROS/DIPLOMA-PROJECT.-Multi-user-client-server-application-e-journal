...
""));
        ...
        pushButton_info->setCursor(QCursor(Qt::OpenHandCursor));
...
"color: rgb(255, 255, 255);"));
        ...
        textEdit_avg_marks->setFont(font2);
        ...
        QFont font5;
        font5.setFamilies({QString::fromUtf8("Cambria")});
        font5.setPointSize(11);
        font5.setBold(true);
        font5.setItalic(true);
        label_studname->setFont(font5);
        ...
        lineEdit_studname->setFont(font3);
        ...
        lineEdit_studclass->setFont(font3);
        ...
        label_marks->setGeometry(QRect(20, 290, 51, 16));
        label_marks->setFont(font3);
        ...
        textEdit_comments->setFont(font1);
        ...
        label_comments->setGeometry(QRect(10, 90, 81, 31));
